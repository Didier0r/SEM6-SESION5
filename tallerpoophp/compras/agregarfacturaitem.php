...
<table class="table">
  ...
  <?php
    ...
    foreach ($arrDetalles as $row) {
      ...
      $precio_venta_f = number_format($precio_venta, 2, ',', '.'); // Formateo de precios
  ...
  ?>
    <tr>
      ...
      <td class='text-center'><a href="#" onclick="eliminar('<?php echo $row['idTmpDetalle']; ?>')"><i class="fa fa-trash"></i></a></td>
    </tr>
  <?php
    }
