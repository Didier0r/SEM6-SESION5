...
if ($action == 'ajax') {
    ...
    $sFields = "`articulos`.`idArticulo`, `articulos`.`descripcion`, round(`articulos`.`precioventa`, 0) as precioventa";
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td class='text-center'>
                            <a class='btn btn-info' href="#" onclick="agregar('<?php echo $idConcepto ?>')"><i class="fa fa-plus"></i></a>
                        </td>
                    </tr>
                    <?php
                }
