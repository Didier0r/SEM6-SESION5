...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial">
        ...
        <tr>
            <td style="width: 50%;">
                <?php
                    ...
                    $cadenaidcliente = "<pre><b>RAZON SOCIAL: </b>" . $rw_razon['razonsocial'] .
                                       "<br><b>CI o RUC: </b>" . $rw_razon['ciruc'] .
                                       "<br><b>DOMICILIO: </b>" . $rw_razon['domicilio'] .
                                       "<br><b>TELEFONO: </b>" . $rw_razon['telefono'] . "</pre>";
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        ...
        <tr>
            ...
            <td style="width: 40%;"><?php echo ($condicion == 1 ? 'CONTADO' : 'CRÉDITO'); ?></td>
        </tr>
    </table>
    <br>
